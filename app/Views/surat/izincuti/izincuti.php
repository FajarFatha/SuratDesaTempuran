...
<div class="container">
    ...
    <form action="/isiizincuti" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="alamatkerja" name="alamatkerja">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="Keperluan" style="height: 100px;" name="keperluan" required></textarea>
            </div>
        </div>
        <div class="row mb-3">
