...
<div class="container">
    <div class="row">
        <div class="col">
            <h3 id="judul">Surat Keterangan Izin Cuti</h3>
        </div>
    </div>
    <form action="/isiizincuti" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="row mb-3">
            <label for="alamatkerja" class="col-sm-3 col-form-label"><b>Alamat kerja</b> </label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="alamatkerja" name="alamatkerja" value="<?= (isset($_SESSION["alamatkerja"])) ? $_SESSION["alamatkerja"] : "" ?>">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="Keperluan" style="height: 100px;" name="keperluan" required><?= (isset($_SESSION["keperluan"])) ? $_SESSION["keperluan"] : "" ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
