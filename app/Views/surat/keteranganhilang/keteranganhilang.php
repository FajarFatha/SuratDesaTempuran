...
<div class="container">
    ...
    <form action="/isiketeranganhilang" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="inputttl3" value="<?= (isset($_SESSION["tempat"])) ? $_SESSION["tempat"] : "" ?>" name="tempat" required>
            </div>
            <div class="col-sm-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="namabarang" style="height: 100px;" name="namabarang" required><?= (isset($_SESSION["namabarang"])) ? $_SESSION["namabarang"] : "" ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label"><b>Hilang di </b></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="hilangdi" value="<?= (isset($_SESSION["hilangdi"])) ? $_SESSION["hilangdi"] : "" ?>" required>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="time" class="form-control" name="jam" value="<?= (isset($_SESSION["jam"])) ? $_SESSION["jam"] : "" ?>">
            </div>
        </div>
        <div class="row mb-3">
