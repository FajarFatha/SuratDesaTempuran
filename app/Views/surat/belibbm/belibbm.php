...
<div class="container">
    ...
    <form action="/isibelibbm" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" value="<?= (isset($_SESSION["tempat"])) ? $_SESSION["tempat"] : "Ngawi" ?>" name="tempat" required>
            </div>
            <div class="col-sm-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="nik" name="nik" value="<?= (isset($_SESSION["nik"])) ? $_SESSION["nik"] : "" ?>">
            </div>
        </div>
        <div class="row mb-3">
