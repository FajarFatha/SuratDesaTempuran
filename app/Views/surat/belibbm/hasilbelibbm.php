...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-sm-5">
            <form action="/belibbm" method="post">
                <input type="hidden" name="slug" value="belibbm">
                <button class="btn btn-warning" type="submit">Edit</button>
            </form>
            <!-- <a href="/back" class="btn btn-danger">Kembali</a> -->
        </div>
        <div class="col-sm-5">
            <a href="/pages" class="btn btn-danger" type="button">Kembali ke Halaman awal</a>
            <!-- <a href="/back" class="btn btn-danger">Kembali</a> -->
        </div>
        <div class="col-sm-2">
            <a href="/belibbmdocx" class="btn btn-primary">download docx file</a>
        </div>
    </div>
    <div class="row">
        <div class="col">
            ...
            $url = "https://api.pdf.co/v1/file/upload/get-presigned-url" .
                "?name=" . urlencode("hasil_belibbm.docx") .
            ...
            if (curl_errno($curl) == 0) {
                ...
                if ($status_code == 200) {
                    ...
                    if (!isset($json["error"]) || $json["error"] == false) {
                        ...
                        $localFile = "../public/hasil/hasil_belibbm.docx";
