...
<div class="container">
    <div class="row">
        <div class="col">
            <h3 id="judul">Surat Pernyataan Miskin</h3>
        </div>
    </div>
    <form action="/isipernyataanmiskin" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="row mb-3">
            <label for="keterangan" class="col-sm-3 col-form-label"><b>Digunakan untuk</b></label>
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="keterangan" style="height: 100px;" name="untuk" required><?= (isset($_SESSION["untuk"])) ? $_SESSION["untuk"] : "" ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
