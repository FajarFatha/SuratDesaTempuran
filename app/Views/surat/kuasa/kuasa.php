...
<div class="container">
    ...
    <form action="/isikuasa" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="number" class="form-control" id="telpon" name="nohp">
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-2">
                <input type="number" id="rt" placeholder="001" name="rw" required>
            </div>
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label"><b>Nama </b></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="inputNama3" name="nama2" required>
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputttl3" class="col-sm-3 col-form-label"><b>Tempat, Tanggal Lahir</b></label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="inputttl3" value="Ngawi" name="tempat2" required>
            </div>
            <div class="col-sm-5">
                <input type="date" class="form-control" name="ttl2" required>
            </div>
        </div>
        <fieldset class="row mb-3">
            <legend class="col-form-label col-sm-3 pt-0"><b>Jenis Kelamin</b></legend>
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="kelamin2" id="kelamin1" value="Laki-Laki" checked>
                    <label class="form-check-label" for="kelamin1">
                        Laki-Laki
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="kelamin2" id="kelamin2" value="Perempuan">
                    <label class="form-check-label" for="kelamin2">
                        Perempuan
                    </label>
                </div>
        ...
        <div class="row mb-3">
            <label for="telpon" class="col-sm-3 col-form-label"><b>No. Telpon</b> </label>
            <div class="col-sm-9">
                <input type="number" class="form-control" id="telpon" name="nohp2">
            </div>
        </div>
        <div class="row mb-3">
            <label for="alamat" class="col-sm-3 col-form-label"><b>Alamat</b></label>
            ...
            <div class="col-sm-2">
                <input type="number" id="rt" placeholder="001" name="rt2" required>
            </div>
            <div class="col-sm-2"></div>
            <div class="col-sm-1">
                <label for="rw">RW</label>
            ...
            <div class="col-sm-2">
                <input type="number" id="rw" placeholder="001" name="rw2" required>
            </div>
        </div>
        <div class="row mb-3">
            <label for="keterangan" class="col-sm-3 col-form-label"><b>Keterangan</b></label>
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="keterangan" style="height: 100px;" name="keterangan" required>Surat Kuasa ini dipergunakan untuk </textarea>
            </div>
        </div>
        <div class="row mb-3">
