...
<div class="container">
    ...
    <form action="/isiketeranganmerantau" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="keterangan" style="height: 100px;" name="keterangan" required>Orang tersebut benar-benar penduduk  Desa Tempuran, Kecamatan Paron, Kabupaten Ngawi, dan saat ini bekerja di </textarea>
            </div>
        </div>
        <div class="row mb-3">
