...
<div class="container">
    <div class="row">
        <div class="col">
            <h3 id="judul">Surat Keterangan Merantau</h3>
        </div>
    </div>
    <form action="/isiketeranganmerantau" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="keterangan" style="height: 100px;" name="keterangan" required><?= (isset($_SESSION["keterangan"])) ? $_SESSION["keterangan"] : "Orang tersebut benar-benar penduduk  Desa Tempuran, Kecamatan Paron, Kabupaten Ngawi, dan saat ini bekerja di ......." ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
