...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-sm-10">
            <form action="/skck" method="post">
                <input type="hidden" name="slug" value="skck">
                <button class="btn btn-danger" type="submit">kembali</button>
            </form>
            <!-- <a href="/back" class="btn btn-danger">Kembali</a> -->
        </div>
        <div class="col-sm-2">
            <a href="/skckdocx" class="btn btn-primary">download docx file</a>
        </div>
    </div>
    <div class="row">
        <div class="col">
            ...
            $url = "https://api.pdf.co/v1/file/upload/get-presigned-url" .
                "?name=" . urlencode("hasil_skck.docx") .
            ...
            if (curl_errno($curl) == 0) {
                ...
                if ($status_code == 200) {
                    ...
                    if (!isset($json["error"]) || $json["error"] == false) {
                        ...
                        $localFile = "../public/hasil/hasil_skck.docx";
