...
<div class="container">
    ...
    <form action="/isiidentitas" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="inputttl3" value="Ngawi" name="tempat">
            </div>
            <div class="col-sm-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="keterangan" style="height: 100px;" name="keterangan">Orang tersebut benar-benar penduduk Dusun ....., Desa Tempuran, Kecamatan Paron, Kab. Ngawi. Bahwa nama ...</textarea>
            </div>
        </div>
        <div class="row mb-3">
