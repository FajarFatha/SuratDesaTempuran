...
<div class="container">
    <div class="row">
        <div class="col">
            <h3 id="judul">Surat Keterangan Usaha</h3>
        </div>
    </div>
    <form action="/isiusaha" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label"><b>Nama usaha</b></label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="namausaha" value="<?= (isset($_SESSION["namausaha"])) ? $_SESSION["namausaha"] : "" ?>" required>
            </div>
        </div>
        <div class="row mb-3">
            <label for="lokasi" class="col-sm-3 col-form-label"><b>Lokasi usaha</b></label>
            <div class="col-sm-9">
                <textarea type="text" class="form-control" id="lokasi" style="height: 100px;" name="lokasiusaha" required><?= (isset($_SESSION["lokasiusaha"])) ? $_SESSION["lokasiusaha"] : "" ?></textarea>
            </div>
        </div>
        <div class="row mb-3">
